package com.pramodit.bankapp.controller;
...
import com.pramodit.bankapp.service.AccountService;
...
public class AccountController {	
	...
	public ResponseEntity<String> deleteaaccount(@PathVariable long accountNumber) {
